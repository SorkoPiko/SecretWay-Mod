...
class $modify(SWPlayLayer, PlayLayer) {
    ...
    void drawRoutes(matjson::Value data) {
        ...
        for (const auto& route : routes) {
            ...
            const auto startLine = CCLayerColor::create(colour, 2.f, 6.f);
            ...
            const auto endLine = CCLayerColor::create(colour, 2.f, 6.f);
            ...
            const auto middleLine = CCLayerColor::create(colour, end-start, 2.f);
